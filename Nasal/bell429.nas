...
# liveries =========================================================
aircraft.livery.init("Aircraft/bell429/Models/liveries");

#doors=========================
leftFrontDoor = aircraft.door.new( "/sim/model/bell429/door-positions/leftFrontDoor", 4, 0 );
rightFrontDoor = aircraft.door.new( "/sim/model/bell429/door-positions/rightFrontDoor", 4, 0 );
leftBackDoor = aircraft.door.new( "/sim/model/bell429/door-positions/leftBackDoor", 4, 0 );
rightBackDoor = aircraft.door.new( "/sim/model/bell429/door-positions/rightBackDoor", 4, 0 );
leftRearDoor = aircraft.door.new( "/sim/model/bell429/door-positions/leftRearDoor", 4, 0 );
rightRearDoor = aircraft.door.new( "/sim/model/bell429/door-positions/rightRearDoor", 4, 0 );
...
aircraft.light.new("sim/model/bell429/lighting/strobe-top", [0.05, 1.00], strobe_switch);
aircraft.light.new("sim/model/bell429/lighting/strobe-bottom", [0.05, 1.03], strobe_switch);

# beacons ===========================================================
var beacon_switch = props.globals.initNode("controls/lighting/beacon", 1, "BOOL");
aircraft.light.new("sim/model/bell429/lighting/beacon-top", [0.62, 0.62], beacon_switch);
aircraft.light.new("sim/model/bell429/lighting/beacon-bottom", [0.63, 0.63], beacon_switch);
aircraft.light.new("sim/model/bell429/lighting/clock", [1.00, 1.00], strobe_switch);
...
var nav_lights = props.globals.getNode("sim/model/bell429/lighting/nav-lights", 1);
...
var Doors = {
	new: func {
		...
		m.active = 0;
		m.list = [];
		foreach (var d; props.globals.getNode("sim/model/bell429/doors").getChildren("door"))
...
var fuel = {
	init: func {
		...
		me.pump_capacity = 6.6 * L2GAL / 60; # same pumps for transfer and supply; from bell429 p2: 6.6 l/min older versions/ 12.5l/min newer versions
...
var turbine = props.globals.getNode("sim/model/bell429/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/bell429/torque-pct", 1);
var torque2_pct = props.globals.getNode("sim/model/bell429/torque2-pct", 1);
var torque3_pct = props.globals.getNode("sim/model/bell429/torque-oei", 1);
var torque4_pct = props.globals.getNode("sim/model/bell429/torque-aeo", 1);
...
var pendulum = props.globals.getNode("/sim/model/bell429/absorber-angle-deg", 1);
...
var Skid = {
	new: func(n) {
		var m = { parents: [Skid] };
		var soundN = props.globals.getNode("sim/model/bell429/sound", 1).getChild("slide", n, 1);
...
var volume_internal = props.globals.getNode("sim/model/bell429/sound/volume_internal", 1);
var volume_external = props.globals.getNode("sim/model/bell429/sound/volume_external", 1);
...
var crash = func {
	if (arg[0]) {
		# crash
		setprop("sim/model/bell429/tail-angle-deg", 35);
		setprop("sim/model/bell429/shadow", 0);
		setprop("sim/model/bell429/doors/door[0]/position-norm", 0.2);
		setprop("sim/model/bell429/doors/door[1]/position-norm", 0.9);
		setprop("sim/model/bell429/doors/door[2]/position-norm", 0.2);
		setprop("sim/model/bell429/doors/door[3]/position-norm", 0.6);
		setprop("sim/model/bell429/doors/door[4]/position-norm", 0.1);
		setprop("sim/model/bell429/doors/door[5]/position-norm", 0.05);
		...
		# uncrash (for replay)
		setprop("sim/model/bell429/tail-angle-deg", 0);
		setprop("sim/model/bell429/shadow", 1);
		doors.reset();
...
var rotor_step = props.globals.getNode("sim/model/bell429/rotor-step-deg");
...
var doors = Doors.new();
#var config_dialog = gui.Dialog.new("/sim/gui/dialogs/bell429/config/dialog", "Aircraft/bell429/Dialogs/config.xml");
...
#aircraft.livery.init("Aircraft/bell429/Models/Variants", "sim/model/bell429/name");
...
toggle_floats = func () {
  ...
  if ( getprop("/sim/model/bell429/emergencyfloats") ) {
